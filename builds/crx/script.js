/* 4chan X - Version 3.13.15 - 2015-12-13
 * https://4chan-x.org/
 *
...
(function() {
  ...
  $.clear = function(cb) {
    ...
    return chrome.storage.local.clear(done);
  };
  ...
  QR = {
    ...
    dialog: function() {
      var dialog, event, flagSelector, name, node, nodes, save, _i, _len, _ref;
  ...
  QR.captcha = {
    ...
    load: function() {
      ...
      if (!(challenge = this.nodes.challenge.firstChild)) {
        return;
      }
      if (!(challenge_image = $.id('recaptcha_challenge_image'))) {
        return;
      }
      this.nodes.img.alt = challenge.value;
  ...
  Main = {
    ...
    initReady: function() {
      var err, errors, href, postRoot, posts, thread, threadRoot, _i, _len, _ref;
